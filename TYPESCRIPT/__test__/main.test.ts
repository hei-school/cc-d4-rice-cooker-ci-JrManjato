...
describe('RiceCooker', () => {
    ...
    it('should add rice when not already present', () => {
        riceCooker.addRice();
    ...
    it('should quit and power off the rice cooker', () => {
        riceCooker.quit();

        expect(riceCooker._isPowered).toBeFalsy();
        expect(consoleSpy).toHaveBeenCalledWith('Thank you for using the Rice Cooker Simulator. Goodbye!');
    });
